...
begin
	...
	select count(*) into vJumData from tblPemesan;
 	select count(*) into vJumData2 from tblMenu;
 	select count(*) into vJumData3 from tblPesanan;
	...
	fetch cPesanan into vNoPemesanan, vNoMenu, vPorsi, vHargaBayar, vDiskon;
		...
		select vNomenu as MENU, vPorsi as JUMLAH, vHargaBayar as HARGA,
...
begin
	...
	set i=i+1;
 	...
 	close cPesanan;
 	set akhir = concat(vNoPemesanan, "=", vHasil,"=",total);
 	return (akhir);
end ;
$$
delimiter ;
